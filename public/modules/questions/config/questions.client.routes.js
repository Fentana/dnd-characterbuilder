...
angular.module('questions').config(['$stateProvider',
    function ($stateProvider) {
        ...
        $stateProvider.
            state('questionnaire', {
                url: '/questionnaire',
                templateUrl: 'modules/questions/views/questionnaire.client.view.html'
            }).
            state('listQuestions', {
                url: '/questions',
                templateUrl: 'modules/questions/views/list-questions.client.view.html'
            }).
            state('questionCalculator', {
                url: '/questionCalculator',
                templateUrl: 'modules/questions/views/result-calculator.client.view.html'
            }).
